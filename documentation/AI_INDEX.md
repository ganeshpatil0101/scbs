...
**Agent Skills:** `.cursor/skills/design-database-schema/`, `.cursor/skills/optimize-ui-ux/` — invoke with `@design-database-schema`, `@optimize-ui-ux`. Rules: `.cursor/rules/generate-document.mdc`, `generate-ui-screen.mdc`, `generate-ui-mockup.mdc`, `coding-standards.mdc`.
