...
| Property | Value |
|---|---|
| Spec | [nave-screen.md](../../../accounting/nave-screen.md) |
| Status | **Draft** |
| Created | 2026-07-16 |
...
- [ ] रोख/बँक radio disables Tab 2 cheque fields when रोख selected
- [ ] Branch/GL/Account Holder use single Autocomplete controls

## Approval

When approved, change Status to **Approved**. Then run `/generate-ui-screen nave-screen`.
