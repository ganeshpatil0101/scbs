...
| Property | Value |
|---|---|
| Spec | ~~[savings-transaction-screen.md](../../../savings/savings-transaction-screen.md)~~ → [deposit-account-transaction-screen.md](../../../accounting/deposit-account-transaction-screen.md) |
| Status | **Superseded** |
| Created | 2026-07-12 |
