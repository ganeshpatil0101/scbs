...
| 5 | खाते क्र. पासून | Account No. From | Textbox | No | Range filter |
| 6 | खाते क्र. पर्यंत | Account No. To | Textbox | No | — |
| 7 | स्थिती | Status | Dropdown | No | `TODO` — full value list not captured. e.g. `सर्व` |

**Link:** `अॅडव्हान्स शोध` (Advance Search) — `TODO — not captured`.
