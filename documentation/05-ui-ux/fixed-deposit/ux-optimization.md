...
**Nominee-as-Customer (2026-07-21):** New Account Tab 2 uses Customer search + quick-add popup; tab hidden by default. See [new-fd-account-screen.md](new-fd-account-screen.md), [../shared/quick-add-customer-pattern.md](../shared/quick-add-customer-pattern.md).
