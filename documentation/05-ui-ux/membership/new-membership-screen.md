...
| 6 | स्थिती | Status | Dropdown | Yes | Default: `चालू` (Active). Values: `चालू` (Active), `बंद` (Closed), `स्थगित` (Suspended) — reuses standard account-status enum, same as [member-register-screen.md](member-register-screen.md) filter |
...
| :---: | :--- | :--- | :--- | :---: | :--- |
| 12 | संचालक | Director | Checkbox | No | Marks whether this member is a director. Default: unchecked |
| 13 | वार्षिक अहवाल | Annual Report | Dropdown | No | Default: `पोस्ट` (Post). Values: `पोस्ट` (Post), `कुरीअर` (Courier) — annual report delivery mode |
...
| 13 | स्थान | Location | Textbox | Yes | Free text — consistent with [new-customer-screen.md](../customer/new-customer-screen.md) address block (resolved 2026-07-22; was Dropdown+TODO) |
...
| 15 | जिल्हा | District | Textbox | Yes | Free text — consistent with [new-customer-screen.md](../customer/new-customer-screen.md) address block (resolved 2026-07-22; was Dropdown+TODO) |
| 16 | तालुका | Taluka | Textbox | Yes | Free text — consistent with [new-customer-screen.md](../customer/new-customer-screen.md) address block (resolved 2026-07-22; was Dropdown+TODO) |
| 17 | शहर | City | Textbox | Yes | Free text — consistent with [new-customer-screen.md](../customer/new-customer-screen.md) address block (resolved 2026-07-22; was Dropdown+TODO) |
...
| # | Marathi Label | English Label | Type | Required | Values / Notes |
| :---: | :--- | :--- | :--- | :---: | :--- |
| 19 | नाते | Relation | Dropdown | Yes | Finalized (2026-07-22) — canonical list, reused by FD/Savings/Daily/Recurring/Loan nominee screens: `मुलगा` (Son), `पुतण्या` (Nephew), `मुली` (Daughter), `मुलगा - पती` (Son - Husband), `पति व मुलगा` (Husband and Son), `वरील प्रमाणे` (As Above), `बायको` (Wife), `मैत्रीण` (Friend), `केअरटेकर` (Caretaker), `लहान भाऊ` (Younger Brother), `स्वतः` (Self), `पत्नी` (Wife), `पती` (Husband) |
